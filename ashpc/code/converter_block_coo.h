...
{    
    ...
    if(BCOO->BlockLength == 0)
    {
        ...
        Memset(BCOO->Blocks[0].Elements, 0, BCOO->BlockWidth * BCOO->BlockHeight * BCOO->Header.FieldSize);
    ...
    else
    {
        ...
        Memset(BCOO->Blocks[BCOO->BlockLength-1].Elements, 0, BCOO->BlockWidth * BCOO->BlockHeight * BCOO->Header.FieldSize);
