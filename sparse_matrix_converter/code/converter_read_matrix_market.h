...
MM_ReadFile(FILE *File, matrix_market *MatrixMarket)
{
    ...
    MatrixMarket->Rows = (u32 *)malloc(MatrixMarket->Header.NonZeroElements * sizeof(u32));
    if(MatrixMarket->Rows == NULL)
    {
        return MALLOC_ERR;
    }
    MatrixMarket->Columns = (u32 *)malloc(MatrixMarket->Header.NonZeroElements * sizeof(u32));
    ...
    for(u32 I = 0; I < MatrixMarket->Header.NonZeroElements; ++I)
    {
        ...
        {
            if(sscanf(Line, "%u %u %lf", &MatrixMarket->Rows[I], &MatrixMarket->Columns[I], 
        ...
        {
            if(sscanf(Line, "%u %u %d", &MatrixMarket->Rows[I], &MatrixMarket->Columns[I], 
